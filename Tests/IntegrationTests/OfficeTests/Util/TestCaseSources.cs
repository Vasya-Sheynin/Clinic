...
public class TestCaseSources
{
    ...
    public static IEnumerable<TestCaseData> UpdateOfficeTestCasesValid
    {
        get
        {
            var id = Guid.Parse("5d1b9a8a-b8e5-4b0e-81a2-f62b07a8c2c5");
            yield return new TestCaseData(id,
                new UpdateOfficeDto(Guid.NewGuid(), "Addr1-2", "+491271", true));
            yield return new TestCaseData(id,
                new UpdateOfficeDto(Guid.NewGuid(), "Addr1-3", "+898098", false));

            id = Guid.Parse("7f9b3f4a-12e6-4d9c-9b7a-6f8b3d4e9c7f");
            yield return new TestCaseData(id,
                new UpdateOfficeDto(Guid.NewGuid(), "Addr2-2", "+98651487", true));
            yield return new TestCaseData(id,
                new UpdateOfficeDto(Guid.NewGuid(), "Addr2-3", "+1589745", false));
        }
    }
    ...
    public static IEnumerable<TestCaseData> CreateOfficeTestCasesValid
    {
        get
        {
            yield return new TestCaseData(
                new CreateOfficeDto(Guid.NewGuid(), "Address123", "+789504", true));
            yield return new TestCaseData(
                new CreateOfficeDto(Guid.NewGuid(), "Str.41", "+89451989", false));
        }
    }
}
